...
import com.croky.common.lang.Path;
...
public final class JsonUtils {
	...
	/**
	 * 返回一个json格式字符串中的xpath描述的路径对应的值
	 * @param json		json字符串
	 * @param xpath		xpath路径。比如json={"date":{"name":["croky","lucy","jack"];"size":60}}，xpath=data.name[1] 则返回lucy
	 * @return 返回json中xpath对应的值
	 */
	public static String getValue(String json,String xpath) {
		...
		try {
			...
			for (int i = 0; i < names.length; i++) {
				...
				if (StringUtils.isNotBlank(path.name)) {
