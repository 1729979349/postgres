...
/**
 * @author Croky.Zheng
 * @date 2023-02-13 15:37:58
*/
@Schema(title = "AlertThresholdeVO-返回null")
public class AlertThresholdeVO implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        AlertThresholdeVO other = (AlertThresholdeVO) that;
